//--------------------------------
// Lab 5 - Direct Memory Access - task01.c
//--------------------------------
//	DMA Performance Example: This task is simply done to show the benefits
//		of using the DMA in moving data. In this task, the DMA should be
//		configured to move data from one C buffer to another C buffer.
//
